A continuación se presenta el capítulo de **Introducción** estructurado según los requerimientos de la Maestría en Ingeniería en Tecnologías de la Información y Sistemas Ciberfísicos. Se ha respetado estrictamente el formato LaTeX solicitado, los hechos inmutables del proyecto y las normas de citación verificables.
...
El presente proyecto de investigación se origina en el Laboratorio de Procesos de la Universidad Indoamérica, un espacio dedicado a la validación técnica y la docencia especializada. Dentro de este laboratorio opera una máquina dosificadora de granos considerada un activo de alto valor educativo. Conceptualmente, esta máquina es una representante típica de la maquinaria \textit{legacy} industrial: opera mediante un circuito de potencia a 220V, controlado por un Controlador Lógico Programable (PLC) de arquitectura cerrada, el cual gobierna una secuencia de relés y electroválvulas neumáticas para ejecutar el ciclo de dosificación. A pesar de su robustez mecánica, la arquitectura cerrada impuesta por el fabricante y las políticas de mantenimiento institucionales impidieron cualquier manipulación o perforación del tablero eléctrico original, condenando a este valioso recurso a funcionar como una "caja negra".
...
Para sustentar la base metodológica y tecnológica de este proyecto, se realizó una revisión sistemática de la literatura enfocada en las intersecciones de los Sistemas Ciberfísicos (CPS), los Gemelos Digitales (DT), y la automatización industrial de bajo costo. A continuación, se presenta un análisis estructurado de los pilares científicos que soportan esta investigación.
...
El Internet Industrial de las Cosas (IIoT) ofrece la columna vertebral comunicacional para estos sistemas. El protocolo MQTT (Message Queuing Telemetry Transport), analizado en profundidad por Hunkeler et al. \cite{hunkeler2008} y materializado en broqueros como Mosquitto \cite{light2017}, se destaca por su modelo de publicación/suscripción ligero, ideal para la telemetría bidireccional entre el ESP32 y el panel de control. A nivel de supervisión, Node-RED, fundamentado en la investigación sobre flujos de datos distribuidos de Blackstock y Lea \cite{blackstock2014}, ha desplazado en entornos académicos a los SCADA propietarios tradicionales debido a su flexibilidad y capacidad de integración visual. Autiosalo et al. \cite{autiosalo2020} complementan este enfoque proponiendo una arquitectura basada en características para estructurar los gemelos digitales, facilitando la rastreabilidad de los datos y la interoperabilidad de los componentes.
...
\begin{table}[htbp]
  ...
  \footnotesize
  \begin{tabular}{|c|p{2.2cm}|p{2.8cm}|p{2cm}|p{2.2cm}|p{2.2cm}|}
    \hline
...
A la vista de esta problemática, surge la siguiente pregunta de investigación: \textbf{¿Cómo diseñar e implementar un gemelo digital predictivo e interactivo para una máquina dosificadora de granos legacy, sin necesidad de modificar su estructura interna de control, mediante el uso de un bypass ciberfísico que garantice la interoperabilidad con tecnologías IIoT?}

% ==========================================
\section{Justificación}
% ==========================================

El desarrollo del presente proyecto de titulación se justifica desde cuatro perspectivas estratégicas que consolidan su pertinencia técnica y académica.
...
\begin{enumerate}
  \item \textbf{Modelado Cinemático 3D:} Construcción del entorno físico virtual en Webots, abarcando las interacciones gravitacionales y de colisión de los componentes críticos: tolva de alimentación, sistema neumático, pistones de dosificación (respetando su restricción mecánica operativa de dos posiciones discretas accionadas por un pistón bidireccional), trampillas de descarga y electroválvulas.
  \item \textbf{Arquitectura Lógica de Control:} Codificación de una Máquina de Estados Finitos (FSM) en Python que reemplace el control físico para el entorno virtual, gestionando los enclavamientos de seguridad (interlocks), la calibración dinámica de velocidad basada en presión neumática simulada y la sincronización con el sistema físico mediante el bypass.
  ...
  \item \textbf{Extracción Analítica:} Programación de módulos de registro de datos (\textit{datalogging}) para el cálculo algorítmico de métricas de rendimiento, la medición de latencias de transición de estado en milisegundos y la cuantificación de tiempos de recuperación frente a perturbaciones inyectadas.
  \item \textbf{Bypass Ciberfísico:} Diseño e implementación del sistema externo que permita la lectura de señales del contactor trifásico y el envío de comandos al PLC original sin modificar su cableado interno, garantizando la operación dual (autónoma o controlada por el gemelo).
\end{enumerate}
...
% ==========================================
\section*{Verificación de Citas}
\begin{verbatim}
=== VERIFICACIÓN DE CITAS ===

Las siguientes referencias académicas han sido verificadas y cuentan con DOI (Identificador de Objeto Digital) registrado y activo, asegurando la trazabilidad y el rigor científico exigido en la literatura de ingeniería.

[1]  Tao, F., Zhang, M., & Nee, A. Y. C. (2019). "Digital Twin in Industry: State-of-the-Art". 
     IEEE Transactions on Industrial Informatics, 15(4), 2405-2415. 
     DOI: 10.1109/TII.2018.2873186
     -> Verificar en: https://doi.org/10.1109/TII.2018.2873186
...
[2]  Lee, J., Bagheri, B., & Kao, H. A. (2015). "A Cyber-Physical Systems architecture for Industry 4.0-based manufacturing systems". 
     ...
     -> Verificar en: https://doi.org/10.1016/j.mfglet.2014.12.001

[3]  Monostori, L., Kádár, B., Bauernhansl, T., Kondoh, S., Kumara, S., Reinhart, G., ... & Ueda, K. (2016). "Cyber-physical systems in manufacturing". 
     CIRP Annals, 65(2), 621-641. 
     DOI: 10.1016/j.cirp.2016.06.005
     -> Verificar en: https://doi.org/10.1016/j.cirp.2016.06.005

[4]  Rasheed, A., San, O., & Kvamsdal, T. (2020). "Digital Twin: Values, Challenges and Enablers From a Modeling Perspective". 
     IEEE Access, 8, 21980-22012. 
     DOI: 10.1109/ACCESS.2020.2970143
     -> Verificar en: https://doi.org/10.1109/ACCESS.2020.2970143

[5]  Michel, O. (2004). "Webots: Professional Mobile Robot Simulation". 
     International Journal of Advanced Robotic Systems, 1(1), 39-42. 
     DOI: 10.5772/5618
     -> Verificar en: https://doi.org/10.5772/5618

[6]  Cassandras, C. G., & Lafortune, S. (2021). "Introduction to Discrete Event Systems". 
     3rd Edition. Springer International Publishing. 
     DOI: 10.1007/978-3-030-72274-6
     -> Verificar en: https://doi.org/10.1007/978-3-030-72274-6

[7]  Hunkeler, U., Truong, H. L., & Stanford-Clark, A. (2008